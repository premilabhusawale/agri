        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
                ...
                <div className="mt-3 space-y-2.5">
                  ...
                  <div className="flex gap-1.5">
                    {[1, 2, 3, 4].map((i) => (
                      <div
                        key={i}
                        className={`h-1.5 flex-1 rounded-full transition-all duration-300 ${i <= strength ? strengthMeta[strength].barClass : "bg-stone-100"
                          }`}
                      />
                    ))}
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-y-1.5 gap-x-2 pt-0.5">
                    {rules.map((r) => {
                      ...
                      return (
                        ...
                        >
                          <div
                            className={`w-3.5 h-3.5 rounded-full border flex items-center justify-center shrink-0 transition-all duration-200 ${pass ? "bg-emerald-500 border-emerald-500 text-white" : "border-stone-200"
                              }`}
                          >
                            {pass && <CheckTiny />}
                          </div>
            ...
            <div>
              ...
              {confirmPassword && (
                <p className={`text-xs mt-1.5 font-medium ${password === confirmPassword ? "text-emerald-500" : "text-red-400"
                  }`}>
